function servicetask34(attempt, message) {
	...
	try{
		//Envia e-mail para Revenda referente a programação de pagamento
		var emailRevenda = DatasetFactory.createConstraint("emailRevenda", hAPI.getCardValue("revContServicoEmail"), "", ConstraintType.MUST); 
