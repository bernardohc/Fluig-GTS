function createDataset(fields, constraints, sortFields) {
	...
	try{
		...
		if(TIPOUSUARIO == ''){
			...
			camposValidos = false;
			newDataset.addRow(new Array('2', 'Código e Loja da Revenda não preenchido.'));
		...
		if(TIPOUSUARIO == 'Revenda' ){
			...
			parametrosGetEquipamento = 'ctipo=1&cCodRev='+A1_COD+'&cLojaRev='+A1_LOJA+'&cNSerie='+equipNumSerie + '&cTpNota=' + equipTipoNota + '' + filterNumNotaFiscal;
