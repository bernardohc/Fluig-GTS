    ...
    var hasErros = false;
        ...
        case ENTREGA:
            ...
            if (getValue("WKCompletTask") == "true" ){
                ...
                if (isEmpty("entKitPriSocorros", form)) {
                    message += getMessage("Kit Primeiros Socorros", 1, form);
                    hasErros = true;
                }else if( form.getValue("entKitPriSocorros")== 'Não'){
                    if (isEmpty("entKitPriSocorrosObs", form)) {	
                        message += getMessage("Kit Primeiros Socorros", 1, form);
                        hasErros = true;
                    }  
                }
        ...
        case RECEBE:
            ...
            if (getValue("WKCompletTask") == "true" ){
                ...
                if (isEmpty("devKitPriSocorros", form)) {
                    message += getMessage("Kit Primeiros Socorros", 1, form);
                    hasErros = true;
                }else if( form.getValue("devKitPriSocorros")== 'Não'){
                    if (isEmpty("devKitPriSocorrosObs", form)) {	
                        message += getMessage("Kit Primeiros Socorros", 1, form);
                        hasErros = true;
                    }  
                }
