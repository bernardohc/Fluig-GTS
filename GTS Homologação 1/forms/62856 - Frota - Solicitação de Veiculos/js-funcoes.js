...
$(document).on("change", "input:radio[name='entKitPriSocorros']", function() {	
	let entKitPriSocorros = $("input:radio[name='entKitPriSocorros']:checked").val();
	if( entKitPriSocorros == 'Não'){
		$('#entKitPriSocorrosObs').show();
	}else{
		$('#entKitPriSocorrosObs').val('');
		$('#entKitPriSocorrosObs').hide();
	}
});
...
$(document).on("change", "input:radio[name='devKitPriSocorros']", function() {	
	let devKitPriSocorros = $("input:radio[name='devKitPriSocorros']:checked").val();
	if( devKitPriSocorros == 'Não'){
		$('#devKitPriSocorrosObs').show();
	}else{
		$('#devKitPriSocorrosObs').val('');
		$('#devKitPriSocorrosObs').hide();
	}
});
