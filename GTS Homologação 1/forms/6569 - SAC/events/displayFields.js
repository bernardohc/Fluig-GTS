function displayFields(form,customHTML){ 
	...
	if(!ehGestorSAC){
		//botao cancelar
		customHTML.append("<script>window.parent.$('#wcm_widget').find('[data-cancel]').css('display','none');</script>");
		customHTML.append("<script>window.parent.$('#wcm_widget').find('[data-cancel]').removeAttr('data-cancel');</script>");
	}
