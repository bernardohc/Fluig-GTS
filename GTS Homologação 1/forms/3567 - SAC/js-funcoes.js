...
function loadForm(){
	...
	{	
		window.parent.$("#formTab").parent().parent().parent().remove();
		window.parent.$("#page-header").remove();
		window.parent.$("#workflowActions").css("display","none");
...
//		$('#tipoPessoaRevenda').prop('readonly',true);
//		$('#cpfCnpjRevenda').prop('readonly',true);
