function createDataset(fields, constraints, sortFields) {
	...
	for (var i in constraints){
		...
		if ( constraints[i].getFieldName().toString() == 'VEND11' ) {
			VEND11 = constraints[i].initialValue;
		}
		if ( constraints[i].getFieldName().toString() == 'VEND12' ) {
			VEND12 = constraints[i].initialValue;
		}
		if ( constraints[i].getFieldName().toString() == 'VEND13' ) {
			VEND13 = constraints[i].initialValue;
		}
