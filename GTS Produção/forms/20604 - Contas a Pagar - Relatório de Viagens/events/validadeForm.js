                    ...
                    if(form.getValue("aprovRelatorio") == 'aprovado'){
                        ...
                        for (var i = 0; i < indexTbRelDespesas.length; i++) {
                            if(form.getValue("rvDespClassi___"+indexTbRelDespesas[i]) == 'Combustível'){
                                ...
                                if (isEmpty("rvDespCnpj___" + indexTbRelDespesas[i], form)) {
                                ...
                                if ( isEmpty("rvDespTpCombText___" + indexTbRelDespesas[i], form)) {
                            ...
                            if (isEmpty("rvDespData___" + indexTbRelDespesas[i], form)) {
                                message += getMessage("Data da despsa", 5, form, "Despesa de Viagens");
                                hasErros = true;
                                rvDespCnpj = true;
                            }if (isEmpty("rvDespValor___" + indexTbRelDespesas[i], form)) {
                                message += getMessage("Valor da despsa", 5, form, "Despesa de Viagens");
                                hasErros = true;
                                rvDespCnpj = true;
                            }
                        }
