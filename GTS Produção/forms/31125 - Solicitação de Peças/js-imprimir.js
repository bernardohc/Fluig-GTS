                ...
                '<table class="table-main">'+
                    ...
                    '<tr><td>'+
                        ...
                        '<div class="header-relatorio">'+
                            ...
                            '			<b>Solicitação de Peças ' + WKNumProces + '</b>' +
                            '		</td>' +
                            '		<td align="center" style="width:  165px;">' +
                            '		</td>' +
                            '	</tr>' +
                        ...
                        '		<th class="fonte-pedido" style="width:15%; text-align:left;">Solicita para?</th>' + 
                        '	</tr>' +
                        '	<tr>' +
                        '		<td class="fonte-pedido" valign="top">' + $("#solNomeSolicitante").val() +'</td>' +
                        '		<td class="fonte-pedido" valign="top">' + $("#Unidade").val() +'</td>' +
                        '	</tr>' +
                        '</table>'+
                        ...
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Produto</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:22%;" >Descrição</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Quantidade</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Tipo</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Observação</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Vendedor</th>' +                        
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Liberação PCP</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Qtde. Liberado</th>' +
                        '		<th class="fonte-pedido" style="text-align:left; width:10%;" >Qtde. Almox</th>' +
                        '	</tr>';
                        $("input[name^=solProduto___]").each(function(index){
                            var index = validafunctions.getPosicaoFilho($(this).attr("id"));
                    HTML +=	'	<tr>' +
                            '		<td style="text-align:left; " class="fonte-itens-pedido" >'+ $("#solProduto___"+index).val() +'</td>'+
                            '		<td style="text-align:left; " class="fonte-itens-pedido" >'+ $("#solDescAtual___"+index).val() +'</td>'+
                            '		<td style="text-align:center; " class="fonte-itens-pedido" >'+ $("#solQuantidade___"+index).val() +'</td>'+
                            '		<td style="text-align:left; " class="fonte-itens-pedido" >'+ $("#solTipo___"+index).val() +'</td>'+
                            '		<td style="text-align:left; " class="fonte-itens-pedido" >'+ $("#solObs___"+index).val() +'</td>'+
                            '		<td style="text-align:left; " class="fonte-itens-pedido" >'+ $("#solVendedor___"+index).val() +'</td>'+
                            '		<td style="text-align:center; " class="fonte-itens-pedido" >'+ $("#solLiberacao___"+index).val() +'</td>'+
                            '		<td style="text-align:center; " class="fonte-itens-pedido" >'+ $("#solQtdeLiberada___"+index).val() +'</td>'+
                            '		<td style="text-align:center; " class="fonte-itens-pedido" >'+ $("#solQtdeAlmox___"+index).val() +'</td>'+
                            '	</tr>';
                        });
                    HTML += '</table>'+
                        //Fim tbody Principal
